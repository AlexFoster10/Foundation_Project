...
## Optimizations
At some point I think optimising the database to store a table of input prices and a table of processed prices would be something I could tackle, as it would allow for large scale data analyis.  
